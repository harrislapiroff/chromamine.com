...
images:
  signin:
    src: image.png
    alt: A screenshot of the 1Password app asking if I want to use a passkey to sign in to a GitHub.
...
1. When you create a passkey, a website asks you want to create a passkey and your credential manager asks you if you want to save the passkey.
