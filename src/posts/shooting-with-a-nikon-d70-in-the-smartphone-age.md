...
iPhones have a "portrait mode" which is designed to simulate a shallower depth of field than their lenses really produce, but it can't produce as coarse of a [bokeh][] as a larger camera lens, often has processing artifacts (especially around people's hair), and looks less natural – because it is less natural; it's simulated by software rather than the pure optics effect of a lens projecting an image onto a sensor.
